...
class RandomForestImputer:
    ...
    def _get_param_distributions(self):
        ...
        Parinktys optimizuotos ekonominių rodiklių imputavimui:
        - n_estimators: 50-300 (daugiau medžių = stabilesni rezultatai)
        - max_depth: 5-30 arba None (neribota)
        - min_samples_split: 2-20 (apsauga nuo overfitting)
        - min_samples_leaf: 1-10 (minimalus lapų dydis)
        - max_features: 'sqrt', 'log2', 0.3-0.7 (features subset)
        """
        return {
    ...
    def _apply_hybrid_post_processing(
        ...
        3. IŠLAIKOMA RF VARIACIJA - RF prognozės išlaikomos maksimaliai
        ...
        base_max_shrinkage = 0.10  # Sumažinta nuo 0.20 - išlaikome 90% RF info
